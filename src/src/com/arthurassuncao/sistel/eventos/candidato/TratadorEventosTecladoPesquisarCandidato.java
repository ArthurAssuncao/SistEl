...
public class TratadorEventosTecladoPesquisarCandidato extends KeyAdapter {
	...
	/** Cria uma instancia do Tratador de eventos do teclado da janela <code>JanelaPesquisarCandidato</code> do pacote {@link com.arthurassuncao.sistel.gui.candidato}
