...
public class TratadorEventosTecladoCadastrarCandidato extends KeyAdapter {
	...
	/** Cria uma instancia do Tratador de eventos do teclado da janela <code>JanelaCadastrarCandidato</code> do pacote {@link com.arthurassuncao.sistel.gui.candidato}
